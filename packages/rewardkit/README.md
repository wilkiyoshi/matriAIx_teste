...
The Matraix Playground Rewardkit is a lightweight package to define and run verifiers. Rewardkit is designed to be used with the Matraix Playground task format but you can use it on its own.
